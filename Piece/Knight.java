...
public class Knight extends Piece {
    ...
    @Override
    public Piece clone() {
        return new Knight(this.pos, this.color);
    }
    ...
    public boolean isValidMove(Piece[][] board, Color c, Position curr, Position next) {
        ...
        if (next.row == curr.row - 1 && next.col == curr.col-2) {
            return checkMove(pieceAtNext, c);
        } else if (next.row == curr.row - 1 && next.col == curr.col+2) {
            return checkMove(pieceAtNext, c);
        } else if (next.row == curr.row - 2 && next.col == curr.col-1) {
            return checkMove(pieceAtNext, c);
        } else if (next.row == curr.row - 2 && next.col == curr.col+1) {
            return checkMove(pieceAtNext, c);
        } else if (next.row == curr.row + 1 && next.col == curr.col-2) {
